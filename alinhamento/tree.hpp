...
class Tree
{
    public:
        ...
        vector<Tabuleiro> generateBoardsInsertion(Tabuleiro board, char player);
        void generateChildren(Node* node, char player, bool jump, bool insert);//gera filhos da raiz
