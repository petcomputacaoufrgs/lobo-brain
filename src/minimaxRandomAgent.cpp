...
#include "../lobo-brain/minimax/alinhamento/board.hpp"
#include "../lobo-brain/minimax/alinhamento/minimaxTree.hpp"
...
#include "../lobo-brain/minimax/alinhamento/minimaxNode.hpp"
...
int play(int depth) {
    ...
    Tabuleiro initialBoard ({{'2', '1', '2'},
                     {'0', '0', '0'},
                     {'1', '2', '1'}});

    Tabuleiro currentBoard = initialBoard;

    vector<Tabuleiro> possibleMoves;

    // starting the game
    Tree* game = new Tree(initialBoard);
